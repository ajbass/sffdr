...
In standard GWAS, SNPs are often correlated due to LD. To account for this, you should provide a logical indicating which SNPs are LD-independent (e.g., via pruning). `sffdr` uses these independent SNPs to fit the model, then computes the significance quantities for the entire dataset.
