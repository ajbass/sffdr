...
The kernel density estimator is highly adaptive. However, sometimes structural artifacts—such as Linkage Disequilibrium (LD) or redundant summary statistics—can induce spurious "bumps" in the null region.
