...
The `sffdr` package implements the surrogate functional false discovery rate (sfFDR) procedure on a set of p-values from a GWAS of interest and  a set of p-values (or test statistics) from a set of informative GWAS. There are a few
